...
btn_equals.grid(row=7, column=5)
btn_dot = tk.Button(root, text=".", command=lambda :add_to_calculation("."), width=5, font=("Arial 14"))
btn_dot.grid(row=7, column=2)
btn_yu = tk.Button(root, text="%", command=lambda :add_to_calculation("%"), width=5, font=("Arial 14"))
btn_yu.grid(row=7, column=3)
...
btn_cf = tk.Button(root, text="^", command=lambda :add_to_calculation("^"), width=5, font=("Arial 14"))
btn_cf.grid(row=7, column=4)
btn_lg = tk.Button(root, text="lg", command=lambda :add_to_calculation("lg"), width=5, font=("Arial 14"))
btn_lg.grid(row=8, column=1)
root.mainloop()